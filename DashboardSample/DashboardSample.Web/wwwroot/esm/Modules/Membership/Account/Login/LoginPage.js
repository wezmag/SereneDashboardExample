...
<div class="text-center mt-2">
    <a class="text-decoration-none" href="${(0,r.resolveUrl)("~/Account/SignUp")}">${(0,r.text)("Forms.Membership.Login.SignUpButton")}</a>
</div>   
`}};l(a,"LoginPanel");
